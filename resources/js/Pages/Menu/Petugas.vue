                            ...
                            <table class="min-w-full divide-y divide-gray-200 table-fixed ">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200 ">
                                    ...
                                    <tr class="hover:bg-gray-100 " v-for="pas in dokter" :key="pas.id">
                                        ...
                                        <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap ">{{ pas.jam_jaga + " s.d. " + pas.jam_siap_jagaz}}</td>
...
export default {
    ...
    methods: {
        ...
        Get_Dokter(){
            this.dokter = []
            axios.get('/api/petugas-get')
            .then(res => {
                this.dokter = res.data.Petugas
            })
            .catch(err => {
                console.error(err);
            })
