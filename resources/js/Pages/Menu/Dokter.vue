                        ...
                        <div class="overflow-hidden ">
                            <table class="min-w-full divide-y divide-gray-200 table-fixed ">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200 ">
                                    ...
                                    <tr class="hover:bg-gray-100 " v-for="pas in dokter" :key="pas.id">
                                        ...
                                        <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap ">{{ pas.spesialis }}</td>
                                        <td class="py-4 px-6 text-sm font-medium whitespace-nowrap border flex justify-center space-x-2">
                                            <button @click="HandleEditProduk(pas.id, pas.nama, pas.alamat, pas.spesialis)" type="button" class="bg-amber-400 hover:bg-amber-600  p-1.5 rounded-sm text-black   hover:text-white">
            ...
            <div v-if="tambah_pasien || edit_pasien">
                <div class="px-8 py-6 ">
                    <div >
                        ...
                        <div class="relative z-0 mb-6 w-full group">
                            <input type="text" v-model="form.spesialis" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                            <label class="absolute text-sm text-gray-500 duration-300 transform -translate-y-6
                            scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500
                            peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75
...
export default {
    ...
    methods: {
        ...
        HandleButtonSubmitEditPasien(){
            ...
            axios({
                    method: "post",
                    url: "/api/dokter-edit/" + this.form.id,
                    data: formData,
                })
                .then((response) => {
                    this.Get_Dokter()
        ...
        HandleEditProduk(id, nama, alamat, spesialis){
            this.data_pasien = false
            this.tambah_pasien = false
